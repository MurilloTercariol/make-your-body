              ...
              child: Column(
                children: [
                  Text(
                    _controller
                        .treinoAtual!
                        .exercicios[_controller.exercicioAtualIndex + 1]
                        .name,
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 18,
  ...
  Widget _buildBotoesControle() {
    return Column(
      children: [
        ...
        // Botão principal - Concluir exercício
        SizedBox(
          width: double.infinity,
          child: ElevatedButton.icon(
            onPressed: _controller.finalizarExercicio,
            ...
            ...(_controller.opcoesTempoDescanso.map((tempo) {
              ...
              return ListTile(
                ...
                title: Text(
                  ...
                  style: TextStyle(
                    color: isSelected ? const Color(0xFFF9C22E) : Colors.white,

...
class _EsqueciViewState extends State<EsqueciView> {
  ...
  late final EsqueciController _esqueciController;

  @override
  void initState() {
    super.initState();
    _esqueciController = GetIt.instance.get<EsqueciController>();
  }
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                // Usar o método verificaemail que já existe
                _esqueciController.verificaemail(context, email);
